...
par(mfrow=c(1,2))
plot(kvec, res['aic', ], type = 'o', main = 'AIC', xlab = 'K', ylab = 'AIC',cex.lab = 1.5,cex.axis= 1.5,cex.main=1.5)
plot(kvec, res['bic', ], type = 'o', main = 'BIC', xlab = 'K', ylab = 'BIC',cex.lab = 1.5,cex.axis= 1.5,cex.main=1.5)
par(mfrow=c(1,1))
```
...
par(mfrow = c(1,2))
plot(w_tsne$Y, pch = 19, col = pal[colData(se)$Level3], cex = 1.5,
     xlab = 'Coordinate 1', ylab = 'Coordinate 2')
legend('bottomright', legend = unique(colData(se)$Level3), 
       fill = unique(pal[colData(se)$Level3]), 
       title = 'Published', cex=0.8)
plot(w_tsne$Y, pch = 19, col = newPal[newClusters], cex = 1.5,
     xlab = 'Coordinate 1', ylab = 'Coordinate 2')
legend('bottomright', legend = names(newPal), fill = newPal,
       title = 'Ours', cex=0.8)
par(mfrow = c(1,1))
```
