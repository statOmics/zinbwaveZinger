...
plot(x = logLib, y = pZero, xlab = "Log library size", ylab = "Fraction of zero's",
     main = "", cex.lab = 2, cex.main = 2, bty = "l", pch = 1, cex.axis = 1.5,
...
ylim = c(0, 3e6)
hist(weights_batch[assay(se) == 0], main = "", cex.lab = 2,
     xlab = "Posterior probability", cex.axis = 2, ylim=ylim)
...
qqplot(weights_batch[assay(se) == 0], weights_nobatch[assay(se) == 0],
       type = 'l', xlab='Posterior Probabilities - Batch', main = 'QQplot',
