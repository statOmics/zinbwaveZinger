...
#GSE74596. downloaded from conquer. Parts of code below from Charlotte Soneson.
...
countsimQCReport(ddsList=list(original=dds_origIslam,zingeR=dds_zingerIslam),
                  outputFile="~/islamMoMNewIterativeSim.html",
                  description = "21/09/2017: islam dataset, unnormalized MoM positive, new simulation with iterative estimation ", calculateStatistics=FALSE)
...
countsimQCReport(ddsList=list(original=dds_origTrapnell,zingeR=dds_zingerTrapnell), outputFile="~/trapnellMoMNewIterativeSim.html", description="21/09/2017: trapnell dataset, Method of Moments on positive counts, new iterative simulation",
calculateStatistics=FALSE)
