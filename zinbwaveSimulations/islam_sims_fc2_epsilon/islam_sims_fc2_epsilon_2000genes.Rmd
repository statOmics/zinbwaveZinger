...
```{r zinbcommondisp}
epsVec = c(1e-4, 1e-2, 1, 1e2, 1e4, 1e6, 1e8, 1e10, 1e12)
...
resListDESeq = lapply(zinbList, function(zinb){
...
plot_fdrtprcurve(cobraplot, plottype = c("curve", "points"), pointsize = 1, linewidth = .5)
```
