...
```{r}
plot_fdrtprcurve(cobraplot, plottype = c("curve", "points"), pointsize = .1, xaxisrange = c(0, 0.2),linewidth = .5)

plot_fdrtprcurve(cobraplotDESeq, plottype = c("curve", "points"), pointsize = .1, xaxisrange = c(0, 0.2),linewidth = .5)
