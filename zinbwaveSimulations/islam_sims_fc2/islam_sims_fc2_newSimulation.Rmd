...
res[['ZINB-WaVE_edgeR_common12']]  = zinbwave_edgeR(counts, grp, zinb_c, ylim=ylim, main = 'ZINB-WaVE, common dispersion', xlim = xlim)
res[['ZINB-WaVE_DESeq2_common12']] = zinbwave_DESeq2(counts, grp, zinb_c)
