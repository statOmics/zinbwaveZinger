...
```{r bcvSim}
dSim=suppressWarnings(edgeR::calcNormFactors(DGEList(simDataIslam$counts)))
dSim=estimateDisp(dSim,design=model.matrix(~grp),prior.df=0)

load('/Users/koenvandenberge/Dropbox/phdKoen/singleCell/zinbwaveZingerGithub/zinbwaveZinger/zinbwaveSimulations/islam_sims_fc2/zinb-common-disp-fc2-eps12.rda')
w = computeObservationalWeights(zinb_c,simDataIslam$counts)
dSimW=suppressWarnings(edgeR::calcNormFactors(DGEList(simDataIslam$counts)))
dSimW$weights = w
