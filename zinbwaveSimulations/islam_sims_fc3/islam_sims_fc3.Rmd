...
```{r help}
#function from https://github.com/statOmics/zingeRPaper/blob/master/singleCellPaper/simulation/simulationHelpFunctions_v6.R
...
fcSim=(3 + rexp(length(DEind), rate = 1/2)) #fold changes
...
save(zinb_c, file = 'zinb-common-disp-fc3.rda')
load('zinb-common-disp-fc3.rda')
```

```{r zinbgenewisedisp}
zinb_g <- zinbFit(core, X = '~ grp', commondispersion = FALSE)
save(zinb_g, file = 'zinb-genewise-disp-fc3.rda')
load('zinb-genewise-disp-fc3.rda')
```

# Compare dispersion estimates
```{r islamDispFC3, warning=FALSE}
