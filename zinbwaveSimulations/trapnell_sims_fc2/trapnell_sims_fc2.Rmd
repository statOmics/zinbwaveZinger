...
```{r data}
## trapnell
load("~/Dropbox/phdKoen/singleCell/zinbwaveZingerGithub/zinbwaveZinger/datasets/countsTrapnell.rda")
keep=rowSums(countsTrapnell>0)>=5
countsTrapnell = countsTrapnell[keep,]
